...
import 'package:untitled3/monitoring_service/utils/user_usage_utils.dart';
...
Future<void> _startTimer(
  ...
  Timer.periodic(const Duration(seconds: 1), (timer) async {
    timer.cancel();
   // Met à jour l'ensemble des applications à surveiller à partir de la base de données.
